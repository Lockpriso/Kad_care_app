...
streamlit.markdown("Notre hôpital est plus qu'une simple installation médicale ; :blue[c'est une communauté]. Nous sommes engagés à travailler en étroite" 
                   ...
                   "la participation communautaire est cruciale pour améliorer les résultats en matière de santé, et nous **accueillons les commentaires de nos patients et de leur famille.**")
streamlit.markdown("Merci de considérer notre hôpital pour vos besoins de santé. Nous sommes impatients de vous servir," 
